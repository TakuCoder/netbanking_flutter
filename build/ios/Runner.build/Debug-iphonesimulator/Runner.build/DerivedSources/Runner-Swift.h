...
SWIFT_CLASS("_TtC6Runner18NewsViewController")
@interface NewsViewController : UIViewController <WKNavigationDelegate, WKUIDelegate>
- (IBAction)goToFlutter:(id _Nonnull)sender;
...
@interface NewsViewController (SWIFT_EXTENSION(Runner))
